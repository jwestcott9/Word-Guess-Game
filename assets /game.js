        ...
        if (alert.innerHTML === "") {
            ...
            if (userGuess.length === 1) {
                ...
                if (x === 0 && y === 0) {
                    ...
                    if (failedCounter === 0) {
                        document.getElementById("hangman").src = "assets /images/hangman-6wrong.png"
                    }
                ...
                if (failedCounter === 0) {
                    alert.innerHTML = ("you lost...the answer was " + answer + "press ROCK!! to play again");
                    losses++;
                ...
                for (i = 0; i < dashes.length; i++) {
                    ...
                    if (z === dashes.length) {
                        alert.innerHTML = (answer + " You Win!! press ROCK!! to play again");
                        wins++;
